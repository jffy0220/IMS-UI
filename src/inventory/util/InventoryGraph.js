...
import FalconLink from 'common/FalconLink'
...
const TabTitle = ({ title, value, percentage, progress }) => (
    <div className="p-2 pe-4 text-start cursor-pointer">
        ...
        <Flex alignItems="center">
            ...
            />
            <h6 className={`fs--2 mb-0 ms-2 ${progress ? 'text-success' : 'text-warning'}`}>{percentage}</h6>
        </Flex>
    </div>
)

const InventoryGraph = ({ chartData, className }) => {
    return (
                        ...
                        <Nav className="nav-tabs border-0 flex-nowrap chart-tab">
                            <Nav.Item>
                                <Nav.Link className="mb-0" eventKey="users">
                                    <TabTitle title="Users" value="3.9K" progress={true} percentage="62.8%" />
                                </Nav.Link>
                            </Nav.Item>
                            <Nav.Item>
                                <Nav.Link className="mb-0" eventKey="sessions">
                                    <TabTitle title="Sessions" value="3.9K" progress={true} percentage="62.8%" />
                                </Nav.Link>
                            </Nav.Item>
                            <Nav.Item>
                                <Nav.Link className="mb-0" eventKey="bounceRate">
                                    <TabTitle title="Bounce Rate" value="3.9K" progress={true} percentage="62.8%" />
                                </Nav.Link>
                            </Nav.Item>
                            <Nav.Item>
                                <Nav.Link className="mb-0" eventKey="sessionDuration">
                                    <TabTitle title="Session Duration" value="3.9K" progress={true} percentage="62.8%" />
                                </Nav.Link>
                            </Nav.Item>
                        </Nav>
                    </Card.Header>
